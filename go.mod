...
require (
	...
	github.com/tel-io/instrumentation/middleware/gin v1.2.6
	github.com/tel-io/tel/v2 v2.3.3
...
require (
	...
	github.com/tel-io/instrumentation/middleware/http v1.2.6 // indirect
